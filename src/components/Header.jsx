  ...
  return (
    <header className="bg-white border-b border-gray-200 sticky top-0 z-10">
      <div className="max-w-screen-2xl flex flex-wrap items-center justify-between mx-auto p-9">
        <div>
          <a href="/">
            <img src="/logo-min.png" className="w-100 h-10 mr-2" alt="Logo" width={145} height={40} />
          </a>
        </div>
        {/* Ícono para menú móvil */}
        ...
        <div id="header-icons" className="hidden lg:flex">
          <a href="/account" className="px-4 transition ease-in-out delay-75 hover:-translate-y-1 hover:scale-110 duration-300">
          ...
          <a href="/orders" className="px-4 transition ease-in-out delay-75 hover:-translate-y-1 hover:scale-110 duration-300">
            <svg width="24" height="24" viewBox="0 0 24 24">
                <path
                    fillRule="evenodd"
                    clipRule="evenodd"
                    d="M4 4h16v2H4V4Zm0 5h16v2H4V9Zm0 5h16v2H4v-2Zm16 5H4v2h16v-2Z"
                />
            </svg>
          </a>

          <a href="/cart" className="px-4 transition ease-in-out delay-75 hover:-translate-y-1 hover:scale-110 duration-300">
            <svg width="24" height="24" viewBox="0 0 24 24">
